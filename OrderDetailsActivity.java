    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     order_details = new String[dbData.size()][];
        ...
        for (int i = 0; i < order_details.length; i++) {
            ...
            it.put("line1", order_details[i][0]);
            it.put("line2", order_details[i][1]);
            it.put("line3", order_details[i][2]);
            it.put("line4", order_details[i][3]);
            it.put("line5", order_details[i][4]);
            list.add(it);
        }
